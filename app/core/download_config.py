...
# 用于生成更综合预报的日出中心时间列表 (本地时间, 24小时制)
SUNRISE_EVENT_TIMES = ["04:00", "05:00", "06:00", "07:00", "08:00"]
# 用于生成更综合预报的日落中心时间列表 (本地时间, 24小时制)
SUNSET_EVENT_TIMES = ["19:00", "20:00", "21:00", "22:00"] # 我调整了一下日落时间，使其更符合实际
